...
extern bool my_detail;
extern string my_config;
...
#define cerr_verbose if (my_verbose) cerr << info_str
#define cerr_verbose_cont if (my_verbose) cerr
#define cerr_detail if (my_detail) cerr << detl_str
#define cerr_detail_cont if (my_detail) cerr
